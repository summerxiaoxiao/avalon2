...
<div class="color-picker__hue">
  <div class="color-picker__hue-container" ref="container"
       @mousedown="handleMouseDown"
       @touchmove="handleChange"
       @touchstart="handleChange">
    <div class="color-picker__hue-pointer" :style="{top: 0, left: pointerLeft}">
      <div class="color-picker__hue-picker"></div>
    </div>
  </div>
</div>
</template>
