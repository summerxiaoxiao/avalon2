<template>
  <div class="d-flex h-container_main h-content-box">
    <div class="flex-lg-column h-flex0-auto h-box-main ">
      <div class="d-flex flex-lg-row h-flex-auto h-main_top__fgs">
        <div class="d-flex flex-lg-column h-main_top__map h-flex1" :style="{'background-image': getBg}">
          <hmain-chart-map
            title="国网福建省电力分公司"
            dwdm="GW21"
            mapDwdm="GW21"
      ...
      <div class="d-flex flex-lg-column h-flex-auto h-main_panel h-main_kkfy__fgs">
        <div class="h-main_box_title ">
