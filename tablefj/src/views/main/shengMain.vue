  ...
  <div class="landing-container h-container_main ">
    <div class="h-content-box h-flex0-auto h-box-main">
      <div class="h-box-column h-flex0-auto h-box-main">
        <div class="h-box-row h-flex-auto h-main_top">
          <div class="h-box-column h-flex1 h-main_top__map" :style="{'background-image': getBg}">
            <hmain-chart-map
              title="国网福建省电力公司"
              dwdm="GW21"
          ...
          <div class="h-box-column h-flex1 h-main_top__listitems ">
        ...
        <div class="h-box-column h-flex-auto h-main_srcb">
          <h-chart-line class="h-main_panel " title="收入成本"
          ></h-chart-line>
        </div>
        <div class="h-box-column h-flex-auto h-main_panel h-main_kkfy">
          <div class="h-main_box_title ">
            <p class="h-title">可控费用</p>
          </div>
          <div class="h-box-column h-flex2 h-main_box_barchart">
