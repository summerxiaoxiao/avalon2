...
class BuildQuery {
  ...
  serialize () {
    ...
    if (this.pzGjgltjs && this.pzGjgltjs.length > 0) {
      condition.pzGjgltjs = this.pzGjgltjs
    }
    if (this.pzGlsxs && this.pzGlsxs.length > 0) {
      condition.pzGlsxs = this.pzGlsxs
    }
    return condition
  }
  toString () {
...
let builder = new BuildQuery()
builder.eq('日期', 'month_id', '201701')
builder.contains('项目编码', 'project_id', '40523', 'or', '!=', '40523100')
builder.eqArray('日期', 'moth_id', ['201701', '201702', '201703'])
builder.eqMap('hello', 123)
let params = builder.serialize()
// console.log(params)

console.log('=====================')
let mybuilder =_.cloneDeep(builder)
mybuilder.eqMap('moth_id', 'hello')
//mybuilder.eqArray('日期', 'moth_id', ['201701', '201702', '201704'])
var res = mybuilder.serialize()
// console.log(res)
console.log('=====================')
console.log(mybuilder.serialize())
